...
import cn.benbenedu.test.pressure.fenke.service.ResultsService;
...
@Slf4j
public class ResultSubmittingBenchmark {
    ...
    public void setUp() {
        ...
        resultsService = applicationContext
                .getBean(ResultsService.class);
    ...
    public void test() {
        ...
        resultsService.submitResult(cookie);
    }
}
